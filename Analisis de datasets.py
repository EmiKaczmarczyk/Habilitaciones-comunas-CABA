# -*- coding: utf-8 -*-
"""Dataset población V9.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1CeoSISb2XeJn9EYqBu8i4Q6jQ-95TB-G

### <img src="http://icons.iconarchive.com/icons/cornmanthe3rd/plex/256/Other-python-icon.png" width="40"> Trabajo Práctico Final Grupo 4 📊

Datasets utilizados:

* habilitaciones-2015-a-2018.csv
* habilitaciones-2019.csv
* MT_eah_2417.xslx
* PDE.xslx
...
"""### <img src="http://icons.iconarchive.com/icons/cornmanthe3rd/plex/256/Other-python-icon.png" width="40"> ETL DATASET PDE.XSLX 📊"""
...
"""### <img src="http://icons.iconarchive.com/icons/cornmanthe3rd/plex/256/Other-python-icon.png" width="40"> CAMBIOS PABLO 20.04.2021 📊"""
...
#Source: https://data.buenosaires.gob.ar/dataset/habilitaciones-aprobadas.

data_2018=pd.read_csv('habilitaciones-2015-a-2018.csv')
data_2018.head(10)

#DESCARTADO PORQUE NO TIENE DATO DE LA COMUNA.

"""### <img src="http://icons.iconarchive.com/icons/cornmanthe3rd/plex/256/Other-python-icon.png" width="40"> ETL DATASET habilitaciones-2019.csv 📊"""

df_habilitaciones_2019=pd.read_csv('habilitaciones-2019.csv')
df_habilitaciones_2019.head()

habil_2019=df_habilitaciones_2019[['solicitud', 'long', 'lat','comuna']]
habil_2019.head()

"""### <img src="http://icons.iconarchive.com/icons/cornmanthe3rd/plex/256/Other-python-icon.png" width="40"> CAMBIOS MARTIN 21.04.2021 📊"""

df_habilitaciones_2019.shape
df_habilitaciones_2019.info()
...
"""### <img src="http://icons.iconarchive.com/icons/cornmanthe3rd/plex/256/Other-python-icon.png" width="40"> CAMBIOS  Pablo 22.04.2021 📊

### <img src="http://icons.iconarchive.com/icons/cornmanthe3rd/plex/256/Other-python-icon.png" width="40"> ETL   MT_eah_2417.xslx 📊
"""

#Promedio de ingreso por capita familiar por comuna 
Data_ingreso='MT_eah_2417.xlsx'
...
"""### <img src="http://icons.iconarchive.com/icons/cornmanthe3rd/plex/256/Other-python-icon.png" width="40"> CAMBIOS  MARTIN 23.04.2021 📊

### <img src="http://icons.iconarchive.com/icons/cornmanthe3rd/plex/256/Other-python-icon.png" width="40"> Mapa por comunas con plotly 📊
"""

# Guardar archivo GeoJSON:
# Using the Chrome browser, go to the url with the json, then right click, then 'Inspect'.
# That brings up the Chrome devtools ui.
# From there go to 'Sources' and you will see the json file in the list.
# Then right click and you will be able to click 'Save as'.

#Guia: https://medium.com/tech-carnot/interactive-map-based-visualization-using-plotly-44e8ad419b97
#GeoJSON file: https://data.buenosaires.gob.ar/dataset/comunas
...
fig = px.choropleth(df_IngreXPob,
...
"""### <img src="http://icons.iconarchive.com/icons/cornmanthe3rd/plex/256/Other-python-icon.png" width="40"> CAMBIOS MARTIN 25.04.2021 📊"""



fig=px.scatter(df_IngreXPob,
...
fig.update_layout(title_text='Relación crecimiento poblacional 2017-2019 con habilitaciones comerciales 2019 y promedio IPCF',
                  showlegend=False,
                  hoverlabel=dict(bgcolor="white",
                                  font_size=12,
                                  font_family="Georgia")
...
fig.update_traces(hovertemplate='<b>Comuna %{hovertext}</b><br>Cantidad de habilitaciones 2019: <b>%{x}</b><br>Crecimiento poblacional 2017-2019: <b>%{y}</b><br>Promedio IPCF: <b>%{customdata[1]:$,.0f}</b><extra></extra>')
...
df_verde=pd.read_csv("espacios-verdes-por-habitante-por-comuna.csv")
df_verde
...
df_IngreXPob.to_csv("df_final.csv")
